...
<html>
    <head>
        <meta charset="utf-8"/>
        <title>FeedMe | Web Service</title>
        <style type="text/css">
            * {
    ...
    <body bgcolor="#00abec" >
        <div id="feature">
            <div id="content">
                <p><b>FeedMe</b><br/>Quản lý Chuỗi bán hàng Thực phẩm</p>
                <h2 style="margin-top: -24px;">Web Service</h2>
                <p>
                    Đây là một JAX Web Service bổ trợ cho ứng dụng web và ứng dụng desktop
                    <br/><br/>
                    
                    <a href="#" onclick="alert('Người thự hiện:\n - Nguyễn Bằng Giang (Trưởng nhóm)\n - Hà Việt Đức\n - Tạ Bắc Hà\n - Vũ Đức Huy\n\nProject 4 - C1410L - Aprotrain Aptech\nDec, 2016')" class="button">
                        Thông tin
